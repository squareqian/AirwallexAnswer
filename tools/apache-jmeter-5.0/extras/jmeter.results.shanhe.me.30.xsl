...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<html lang="en">
			...
			body {
                ...
                * { margin: 0; padding: 0 }
				...
				#top-panel { position: absolute; left: 0; top: 0; bottom: 0; width: auto;font-size: 16px; }
                #left-panel { position: absolute; left: 0; top: 80px; bottom: 0; width: 300px; overflow: auto; background: #dee4ea;border: 0.5px solid #2674a6}
                ...
                #right-panel { position: absolute; right: 0; top: 80px; bottom: 0; left: 300px; overflow: auto; background: white ;border: solid 0.5px #2674a6}
					...
					<ol id="result-list">
						<xsl:for-each select="*">
							...
							<xsl:if test="position() = 1 or @tn != preceding-sibling::*[1]/@tn">
								<li class="navigation">Thread: <xsl:value-of select="@tn"/>
								</li>
							</xsl:if>
									...
									<div class="zebra">
										<table>
											...
											<tr>
												...
												<td class="data delimiter">:</td>
												<td class="data">
													<xsl:value-of select="@t"/> ms</td>
											</tr>
											<tr>
												<td class="data key">Latency</td>
												<td class="data delimiter">:</td>
												<td class="data">
													<xsl:value-of select="@lt"/> ms</td>
											</tr>
											<tr>
	...
	<xsl:template name="summary" match="/testResults/*">
		...
		<table align="center" class="details" border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
				<th># Test Case</th>
				<th>Request Samples</th>
				<th>Request Success</th>
				<th>Request Failures</th>
				<th>Success Rate</th>
			</tr>
			<tr valign="top">
				<xsl:variable name="allThreadCount" select= "count(*[not(@tn=preceding-sibling::*/@tn)])"/>
